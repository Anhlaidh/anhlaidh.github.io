...
4. 浮点数需要注意精度
   ![浮点数](images/2020-03-12-17-32-39.png)

5. BigInteger
  - 支持无限大的整数运算
    ![BigInteger](images/2020-03-12-18-45-07.png)
6. BigDecimal -支持无限大的小数运算
  - 注意精度和截断
    ![BigDecimal](images/2020-03-12-17-51-58.png)
7. 随机数

![随机数](images/2020-03-11-18-08-16.png)
...
1. NumberFormat
   ![DecimalFormat](images/DecimalFormat.png)
2. MessageFormat
...
- Properties 同步，文件形式，数据量小    
  ...
  ![get&writeProperties](images/get&writeProperties.png)
  ![main&getValue](images/main&getValue.png)
...
- Collections  
  ![](images/021a01f2.png)  
  -对象的比较  
  ![comparable](images/eb55ee78.png)
...
-   ![testFiles1](images/testFiles1.png)
-   ![testFiles2](images/testFiles2.png)
